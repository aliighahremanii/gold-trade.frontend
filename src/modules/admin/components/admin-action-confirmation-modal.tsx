...
type AdminActionConfirmationModalProps = {
  isOpen: boolean;
  title: string;
  description: string;
  confirmLabel: string;
...
export function AdminActionConfirmationModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      ...
      >
        <h2 id="admin-action-confirmation-title" className="text-lg font-semibold text-zinc-900 dark:text-zinc-50">
          {title}
        </h2>
        ...
        <div className="mt-6 flex flex-wrap justify-end gap-3">
          <button
            ...
            className="rounded-md border border-zinc-300 px-4 py-2 text-sm font-medium text-zinc-900 hover:bg-zinc-50 disabled:opacity-60 dark:border-zinc-700 dark:text-zinc-50"
          >
            Cancel
          </button>
          <button
