# Security and Observability Prompt
...
Harden frontend security, logging, telemetry, and operational visibility.
...
- Review env vars.
- Add security headers/deployment notes.
- Add safe error reporting strategy.
- Add request/correlation id display/logging where safe.
- Add admin authorization guard tests.
- Ensure no sensitive data logs.
