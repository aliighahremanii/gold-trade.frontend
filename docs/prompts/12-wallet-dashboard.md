...
Implement wallet and portfolio visibility for IRR and XAU.
...
- Balance cards for available/locked/total.
- Asset rows with units.
- Last updated/loading/error states.
- No optimistic balance mutation.
- Tests for formatters and balance display.
