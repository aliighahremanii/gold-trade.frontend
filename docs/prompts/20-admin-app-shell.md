...
Implement the admin/backoffice route shell and navigation.
...
- Navigation: pricing, market status, orders, approvals, payments, delivery, ledger, audit, reconciliation.
