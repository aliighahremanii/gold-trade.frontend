# Admin Pricing and Market Status Prompt
...
Implement admin manual pricing and market status operations.
...
- Current price view.
- Manual price form with reason/validity.
- Market status open/closed/manual-only controls.
- Confirmation dialog for sensitive actions.
- Audit visibility links where backend supports it.
