# Admin Payments and Delivery Prompt
...
Implement admin payment, withdrawal, and delivery operations.
...
- Payment/deposit table.
- Withdrawal review table.
- Delivery request table.
- Delivery scheduling/completion actions.
- Confirmation and audit-aware UX.
- Filters by status/date/user/reference.
