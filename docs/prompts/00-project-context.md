...
Load the frontend project context, read all instruction and business knowledge files, and produce a concise implementation plan without changing code unless the repository is empty and needs documentation placement.
...
- Identify package manager and existing app structure.
- Identify backend OpenAPI availability.
- Produce a short plan for the next phase.
