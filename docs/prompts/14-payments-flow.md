...
Implement IRR deposit and withdrawal UX.
...
- Deposit initiation.
- Payment pending/completed/failed states.
- Withdrawal request form.
- Withdrawal status list/detail.
- Idempotency key support where backend exposes it.
- Refetch wallet after confirmed payment state.
