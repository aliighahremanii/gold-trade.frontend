...
Implement Playwright tests for MVP customer and admin workflows.
...
- Customer buy/sell happy path.
- Deposit/withdraw happy path if test backend supports it.
- Delivery happy path with admin approval.
- Admin manual price/market status flow.
- E2E fixtures and test data strategy.
- CI integration.
