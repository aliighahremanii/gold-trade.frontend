# CI/CD and Production Review Prompt
...
Review CI workflow, Dockerfile, Caddy/deployment docs, environment variable docs, build validation, and E2E report artifacts.
