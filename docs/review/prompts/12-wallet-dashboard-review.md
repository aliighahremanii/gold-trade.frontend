# Wallet Dashboard Review Prompt
...
Review wallet display correctness, available/locked balances, refetch strategy, formatting, and no optimistic balance mutation.
