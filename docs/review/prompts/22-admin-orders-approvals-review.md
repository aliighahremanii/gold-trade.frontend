# Admin Orders and Approvals Review Prompt
...
Review order tables/details, manual review queue, approval/rejection state, reason fields, and provider/settlement failure visibility.
