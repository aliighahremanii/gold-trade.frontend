# Security and Observability Review Prompt
...
Review auth/session safety, admin protection, environment variables, sensitive logging, security headers, and telemetry strategy.
