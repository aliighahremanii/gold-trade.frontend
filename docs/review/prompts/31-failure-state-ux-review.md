# Failure State UX Review Prompt
...
Review coverage of expired quote, provider failure, settlement failure, payment pending/failure, duplicate submit, and manual review UX.
