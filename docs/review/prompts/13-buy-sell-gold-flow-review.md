# Buy/Sell Gold Flow Review Prompt
...
Review quote creation, quote expiry, confirmation, duplicate submit protection, order/settlement states, error handling, and wallet invalidation.
